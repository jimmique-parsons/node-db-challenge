...
Relation Databases are databases that store their data in tables. While SQL (Structured Query Language) is the standard language for managing databases and the data within them.

- [ ] Why do tables need a `primary key`?

They need a primary key to uniquely identify each row in a table.  Usually you'd use primary keys in order for your table to be JOINable.
